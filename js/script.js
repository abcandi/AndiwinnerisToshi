...
var countFromDate = new Date("May 21, 2022 11:00:00").getTime();
...
var x = setInterval(function() {
    ...
    // Find the distance between now and the countFromDate
    var timePassed = now - countFromDate;
...
console.log('%cYour presence is requested!%c\n\nRegards: Toshi & Andi', styles1, styles2);
